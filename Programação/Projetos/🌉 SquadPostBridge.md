...
Ferramenta automatizada para geração de posts para o LinkedIn usando OpenAI GPT. Suporta múltiplos idiomas, personalização com hashtags e links, e possui interface web via Streamlit. Inclui sistema de logging robusto.

https://github.com/ericksonlopes/SquadPostBridge
