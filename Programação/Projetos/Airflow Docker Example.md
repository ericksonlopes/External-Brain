...
Exemplo de configuração e inicialização do Apache Airflow com Docker Compose. Inclui script de setup automatizado que cria diretórios, define variáveis de ambiente, constrói a imagem Docker e sobe os containers.

https://github.com/ericksonlopes/airflow-docker-example
